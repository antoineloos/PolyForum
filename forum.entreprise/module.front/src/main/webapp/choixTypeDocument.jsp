                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo text-center">
                            <span class="text-center"><h2>Choisissez le type de document que vous souhaitez consulter.</h2></span>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="panel-body row col-md-6 offset-3 topoffset4">
                                <div class="col-md-6">
                                    <a href="consulterCV.file" >
                                        <input type="submit" class="btn btn-danger" name="boutton_cv" value="CV">
                                    </a> 
                                </div>
                                ...
                                <div class="col-md-3" >
                                    <a href="consulterOffres.file" >
                                        <input type="submit" class="btn btn-danger"
                                                name="boutton_offre" value="Offre"></a>
                                </div>
