            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="logo text-center">
                        <span class="text-center"><h2>Gérer les salles</h2></span>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <tr id="${salle.idSalle}">
                                ...
                                <td width="10%" style="text-align: center;">
                                    <c:if test="${salle.disponible == 'true'}">
                                        <input type="checkbox" data-toggle="toggle" name="presence" class="presence" checked="checked" id="${salle.idSalle}">
                                    </c:if>
                                    <c:if test="${salle.disponible == 'false'}">
                                        <input type="checkbox" data-toggle="toggle" name="presence" class="presence" id="${salle.idSalle}">
                                    </c:if></td>
                                <td width="5%"><button type="button" name="remove" id="${salle.idSalle}" class="btn btn-danger btn_remove">X</button></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
            </div>
            <form method="get" action="saisieSalle.adm">
                <button type="submit" class="btn btn-primary btn-lg outline">Ajouter une salle</button>
            </form>
        </div>
    </div>
    <script>
        ...
        function presence(id) {
            ...
            $
                    .ajax({
                        ...
                        success: function (msg) {
                            alerty
                                    .toasts("Disponibilité modifiée ! Générez le planning pour tenir compte de ce changement");
                        }
                    });
        }
        ;
